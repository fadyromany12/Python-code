"""
AutoPan Node — v13  (Raspberry Pi 4B/5 — Blueprint-Aligned)
============================================================
...
Run modes
---------
    python autopan_v13.py                   # normal
    python autopan_v13.py --no-serial       # vision only
    python autopan_v13.py --port /dev/ttyACM0
    python autopan_v13.py --imgsz 256       # slower Pi
    python autopan_v13.py --debug-hsv
    python autopan_v13.py --calibrate       # MUST re-run on Pi 5 with Pi camera
    python autopan_v13.py --int8            # use INT8 ONNX model
    python autopan_v13.py --target-count 5  # collect 5 balls

Step 1 (once):  python export_onnx.py
Step 2:         python autopan_v13.py
...
class Config:
    ...
    # WILL differ → re-run:  python autopan_v13.py --calibrate
...
class AutoPanTracker:
    ...
    def run(self):
        ...
        log.info("AutoPan v13 running. Press Q to quit.")
...
if __name__ == "__main__":
    ap = argparse.ArgumentParser(description="AutoPan v13")
